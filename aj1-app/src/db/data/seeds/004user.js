...
exports.seed = async function(knex) {
  ...
  await knex("user").insert([
    {id: 1, login_number: 1111111, user_name: "雅野 浅夫", password: "1234567", role:0, token: "js", department_id: 1},
    ...
    {id: 9, login_number: 9999999, user_name: "出比留 萬", password: "1234567", role:1, token: "js9", department_id: 1}
  ]);
};
