...
exports.seed = async function(knex) {
  ...
  await knex('user_budge').insert([
    ...
    {user_id: 2, budge_id: 7, user_id_budge_id: 27,status:2,url:"https://google.com",certification_date:"2022/09/01",unchecked:0},
    ...
    {user_id: 3, budge_id: 10, user_id_budge_id: 310,status:2,url:"https://google.com",certification_date:"2022/09/01",unchecked:0},
