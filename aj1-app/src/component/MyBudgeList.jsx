  ...
  return (
    <>
      ...
      <div className="container">
        ...
        :
        (
          <Table striped responsive className="container bg-light rounded-4 mt-15" id="table">
            <thead>
              <tr>
                <th className="table some-other-class-1">資格名</th>
                <th className="table some-other-class-2">取得日</th>
      ...
      <div className="container">
        <h2 className="container text-light d-flex justify-content-start mt-15">・申請中</h2>
      </div>
      {
        (budge.filter(record => record[1] === 1).length === 0) ?
          <h4>表示するものがありません</h4>
        :
        (
          <Table striped bordered className="container bg-light rounded-4 mt-15" id="table">
            <thead>
              <tr>
                <th className="table some-other-class-1">資格名</th>
                <th className="table some-other-class-2">取得日</th>
      ...
      <div className="container">
        <h2 className="container text-light d-flex justify-content-start mt-15">・棄却</h2>
      </div>
      {
        (budge.filter(record => record[1] === 3).length === 0) ?
          <h4>表示するものがありません</h4>
